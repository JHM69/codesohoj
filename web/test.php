  ...
  <div class="w-4/5 bg-white rounded-lg shadow-lg p-6 py-4">
    ...
    <form class="max-w-4xl mx-auto mt-8" method="post" action="<?php echo SITE_URL; ?>/process.php" enctype='multipart/form-data'>
      <div class="mx-auto bg-white border border-grey-300 rounded rounded-lg shadow-lg p-6 py-4">
        ...
        <div class="mb-4">
          <label for="statement" class="block text-gray-700 font-bold mb-2 flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">Problem Statement</label>
          <div class="mt-2">
        ...
        <div class="mb-4">
          ...
          <input class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" type="text" name="code" id="code">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          <label for="score" class="block text-gray-700 font-bold mb-2 flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">Score</label>
          <input class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" type="text" name="score" id="score" value="100" required>
        </div>
        <div class="flex flex-wrap -mx-2">
          <div class="w-1/2 mb-4">
            <label for="input" class="block text-gray-700 font-bold mb-2 flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">Input File</label>
          ...
          <div class="w-1/2 mb-4">
            <label for="output" class="block text-gray-700 font-bold mb-2 flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">Output File</label>
        ...
        <div class="form-group mb-4">
          <label class="block text-gray-700 font-bold mb-2" for="pgroup">Problem Group</label>
        ...
        <div class="flex flex-wrap -mx-2">
          <div class="form-group w-1/2 px-2 mb-4">
            <label class="block text-gray-700 font-bold mb-2  " for="sampleinput">Sample Input File</label>
            <div class="mt-2">
            <textarea type="text" name="sampleinput" id="sampleinput" required rows="10" class="block w-full border-gray-300 p-2 rounded-md placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full h-100px text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6"></textarea>
          </div>
          </div>
          <div class="form-group w-1/2 px-1 mb-4">
            <label class="block text-gray-700 font-bold mb-2  " for="sampleoutput">Sample Output File</label>
            <div class="mt-2">
            <textarea type="text" name="sampleoutput" id="sampleoutput" required rows="10" class="block w-full border-gray-300 p-2 rounded-md placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full h-100px text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 sm:text-sm sm:leading-6"></textarea></div>
          </div>
        </div>
        <div class="form-group mb-4">
        ...
        <div class="form-group mb-4">
          <label class="block text-gray-700 font-bold mb-2  " for="timelimit">Time Limit (s)</label>
          <input class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" type="text" name="timelimit" id="timelimit" value="1" required>
        </div>
        <!-- <div class="form-group">
            <label class="block mb-2  " for="languages">Languages Allowed</label>
        ...
        <div class="form-group mb-4">
          <label class="block text-gray-700 font-bold mb-2" for="maxfilesize">Max File size (MB)</label>
          <input class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" type="text" name="maxfilesize" id="maxfilesize" value="256">
        </div>
        <div class="form-group mb-4">
          <label class="block text-gray-700 font-bold mb-2" for="displayio">Display IO</label>
