    ...
    <body class="text-gray-800 antialiased">
        ...
        <main>
            ...
            <div class="pl-12 rounded w-full flex justify-center items-center">
                ...
                <a href='<?php echo SITE_URL; ?>/add_contest.php'><button class="m-10 bg-green-500 text-white rounded block p-2 m-20 text-lg font-bold" style="margin: 10px auto; margin-bottom: 10px;">Add Contest</button></a>
            </div>
