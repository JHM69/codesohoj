      ...
      >
        ...
        >
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
            ...
            <?php
            echo '<script>console.log("Jahnagir Hossain");</script>';

            if (isset($_SESSION["loggedin"])) { ?>
                        <ul class="">
                            <?php if (
                              $_SESSION["team"]["status"] == "Admin"
                            ) { ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href='/adminjudge'>Judge Settings</a></li>
                                        <li><a href='/adminproblem'>Problem Settings</a></li>
                                        <li><a href='/admincontest'>Contest Settings</a></li>
                                        <li><a href='/adminteam'>Team Settings</a></li>
                                        <li><a href='/admingroup'>Group Settings</a></li>
                                        <li><a href='/adminclar'>Clarifications</a></li>
                                        <li><a href='/adminbroadcast'>Broadcast</a></li>
                                        <li><a href='/adminlog'>Request Logs</a></li>                                            
                                    </ul>
                                </li>                              
                            <?php } ?>
                            <li class="dropdown">
